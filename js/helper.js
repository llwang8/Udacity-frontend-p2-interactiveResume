...
var HTMLemail = '<li class="flex-item"><a class="orange-text" href="mailto:%data%" >email</a></li>';
var HTMLtwitter = '<li class="flex-item"><a class="orange-text" href="%data%" >twitter</a></li>';
var HTMLcodepen = '<li class="flex-item"><a class="orange-text" href="%data%" >Codepen</a></li>';
var HTMLgithub = '<li class="flex-item"><a class="orange-text" href="%data%" >github</a></li>';
var HTMLblog = '<li class="flex-item"><span class="orange-text">blog</span><span class="white-text">%data%</span></li>';
var HTMLlocation = '<li class="flex-item"><span class="orange-text">location</span><span class="white-text">%data%</span></li>';

var HTMLbioPic = '<img width="" height="" src="%data%" class="biopic">';
...
var HTMLprojectLink = '<a class="project-link" href="%data%"> - Link</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<img src="%data%" class="projpic">';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<a href="#" class="school-text">%data%';
...
/*
 Hook up js code to the button that is appending.
*/
